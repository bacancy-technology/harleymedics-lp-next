  ...
  return (
    <div>
          ...
          <div className='row'>
            ...
            >
              <div className={`d-flex ${styles.header_top_level}`}>
                <Link href='https://www.lovelymeds.com/'>
                  <a title=''>
                    <img
                      src='/images/lovelymeds.png'
                      width={180}
                      height={54}
      ...
      <div className={`row ${styles.trust_org_section}`}>
        <h6>
          {' '}
          <a className='' href='https://www.lovelymeds.com/'>
            Lovely Meds
          </a>{' '}
          As Featured In:
        </h6>
        <div className={`${styles.org_logo_section}`}>
          ...
          <img
            ...
            src='/images/Logo-new-strap-RGB-mono-01.png'
          />
          <img
            className='w-100 h-100'
            style={{
